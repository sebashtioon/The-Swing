...
func _on_sit_down_button_mouse_entered() -> void:
	$camera_pos/camera_pivot/main_camera/TitleScreenLayer/SitDownLabel.modulate = Color(0.805, 0.805, 0.805)
	$camera_pos/camera_pivot/main_camera/TitleScreenLayer/SitDownRightArrow.modulate = Color(0.805, 0.805, 0.805)

func _on_sit_down_button_mouse_exited() -> void:
	$camera_pos/camera_pivot/main_camera/TitleScreenLayer/SitDownLabel.modulate = Color(1, 1, 1, 1)
